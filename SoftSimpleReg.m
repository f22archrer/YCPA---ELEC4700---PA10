% This file simulates a wave reflecting off a square material of different
% dielectric constant
...
global AsymForcing
global delsglobal SurfHxLeft SurfHyLeft SurfEzLeft SurfHxRight SurfHyRight SurfEzRight
...
% Create mu matrix for structure

mu{1} = ones(nx{1},ny{1})*c_mu_0;

% Create epsilon structure
